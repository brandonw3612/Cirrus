...
/// </summary>
internal abstract class EventTriggerBehaviorBase<T> : Trigger<T> where T : DependencyObject
{
    /// <summary>
    ...
    public static readonly DependencyProperty EventTriggerFilterProperty = DependencyProperty.Register(
        nameof(EventTriggerFilter),
        typeof(EventTriggerFilter),
        typeof(EventTriggerBehaviorBase<T>),
        new PropertyMetadata(null, OnSourceObjectChanged));
    ...
    /// If <seealso cref="SourceObject"/> is not set, the source will default to <seealso cref="Microsoft.Xaml.Interactivity.Trigger{T}.AssociatedObject"/>. This is a dependency property.
    /// </summary>
    ...
    public EventTriggerFilter? EventTriggerFilter
    {
        get => (EventTriggerFilter?)GetValue(EventTriggerFilterProperty);
        set => SetValue(EventTriggerFilterProperty, value);
    }
    ...
    {
        if (EventTriggerFilter is { } filter && !filter.Validate(eventArgs)) return;
    ...
    private static void OnSourceObjectChanged(DependencyObject dependencyObject,
