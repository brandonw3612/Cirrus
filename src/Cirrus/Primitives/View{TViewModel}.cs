...
public abstract class View<TViewModel> : Page where TViewModel : ViewModel, new()
{
    ...
    public static readonly DependencyProperty ViewModelProperty = DependencyProperty.Register(
        nameof(ViewModel), typeof(TViewModel), typeof(View<TViewModel>),
            ...
            switch (exception)
            {
                ...
                default:
                {
                    switch (await window.DialogController.ShowMessageBoxAsync(
                                "MessageBoxes/Error/Title".GetLocalized() ?? "{InvalidResource}",
                                string.Format(
                                    "MessageBoxes/PageLoadNetworkIssue/Content/Format".GetLocalized() ??
                                    "{InvalidResource}", exception.Message),
